...
^1^Programa de Pós-Graduação Stricto-Sensu em Epidemiologia em Saúde Pública, Escola Nacional de Saúde Pública Sergio Arouca, Fundação Oswaldo Cruz.
...
Observa-se a seguir, (@fig-Figura3 e @fig-Figura4) que os pressupostos de independência e linearidade da regressão logística são atendidos, de forma que podemos interpretar seus resultados do modelo.
